...
const memory = fs.readFileSync(path.join(__dirname, filename)).toString().split(',').map(i => Number(i));
const input = 5;
        ...
        while (array[index] !== 99 && array[index] !== 1109) {
            ...
            switch (opcode) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    index = convertParamByMode(array, modeParam1, value1) !== 0 ? convertParamByMode(array, modeParam2, value2) : index + 3
                    break;
                case 6:
                    index = convertParamByMode(array, modeParam1, value1) === 0 ? convertParamByMode(array, modeParam2, value2) : index + 3
                    break;
                case 7:
                    array[value3] = convertParamByMode(array, modeParam1, value1) < convertParamByMode(array, modeParam2, value2) ? 1 : 0
                    index += 4;
                    break;
                case 8:
                    array[value3] = convertParamByMode(array, modeParam1, value1) === convertParamByMode(array, modeParam2, value2) ? 1 : 0
